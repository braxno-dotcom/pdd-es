...
*/
var PREGUNTAS = require("./preguntas.js").concat(require("./preguntas-auto.js"));
// ⚠️ Проверяем ОБА банка разом: рукописный и собранный из таблиц. Машинный
// ошибается иначе — например, ровными короткими вариантами, — и ловить это
// надо тем же прибором.
